...
export default function BookAppointmentPage({
  ...
  const generateTimeSlots = () => {
    ...
    const start = dayjs(`2000-01-01 ${startTime}`).toDate();
    const end = dayjs(`2000-01-01 ${endTime}`).toDate();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isAuthenticated) {
      ...
      router.push(
        `/auth/login?redirect=/business/${businessId}/service/${serviceId}/book`
      );
      return;
    }
          ...
          <Alert className="bg-yellow-50 border-yellow-200">
            ...
            <AlertDescription>
              ...
              <Button
                ...
                onClick={() =>
                  router.push(
                    `/auth/register?redirect=/business/${businessId}/service/${serviceId}/book`
                  )
                }
              >
                create an account
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      {service.availability && (
                        <p className="text-sm text-muted-foreground mt-2">
                          Business hours: {service.availability.startTime} -{" "}
